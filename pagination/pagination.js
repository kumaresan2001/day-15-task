...
var bth_first=document.querySelector('bth-first')
...
btn_Next.addEventListener('click',()=>{
    ...
    var iter_val = (parseInt(user_data/10))*9
    ...
    for(i=1;i<=10;i++)
    {
        ...
        {
              var increasing_attribute_val = attribute_val + 10
...
btn_Previous.addEventListener('click',()=>{
  ...
  
    {
       ...
       var attribute_val_for = parseInt(taking_for.getAttribute('for'))
            if (attribute_val_for>10)
            {
                var increasing_attribute_val = attribute_val_for - 10
                taking_for.setAttribute('for',increasing_attribute_val)
                taking_for.innerText = increasing_attribute_val
            }
    }
})
bth_first.addEventListener('click',()=>{
